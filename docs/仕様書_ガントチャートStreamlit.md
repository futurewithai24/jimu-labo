...
```
E:\Maruno-Mai-AI-Office\04_開発部\Streamlit\
...
```
mkdir E:\Maruno-Mai-AI-Office\Streamlit
```
...
> **保存場所：** `E:\Maruno-Mai-AI-Office\04_開発部\Streamlit\app.py`（Windowsの場合）
...
```
cd E:\Maruno-Mai-AI-Office\Streamlit
...
PowerShellで実行：
```
mkdir E:\Maruno-Mai-AI-Office\04_開発部\Streamlit\pages
```
...
PowerShellで実行：
```
copy E:\Maruno-Mai-AI-Office\04_開発部\Streamlit\app.py E:\Maruno-Mai-AI-Office\04_開発部\Streamlit\pages\1_ガントチャート.py
```
